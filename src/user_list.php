...
class UserList
{
    ...
    function items()
    {
        ...
        $query = "SELECT * FROM user_list_items WHERE user='" . $this->get_user() .
    ...
    function add($dissertation_id)
    {
        ...
        $sql = "INSERT INTO user_list_items (list, user, dissertation_id)" .
    ...
    function remove($dissertation_id)
    {
        ...
        $sql = "DELETE FROM user_list_items WHERE dissertation_id='" . $dissertation_id .
